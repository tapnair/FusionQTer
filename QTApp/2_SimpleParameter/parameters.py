...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.label_3.setGeometry(QRect(100, 170, 81, 21))
        ...
        self.mass_display.setGeometry(QRect(210, 170, 81, 23))
        ...
        self.button.setGeometry(QRect(130, 110, 131, 32))
        self.refresh = QPushButton(Form)
        self.refresh.setObjectName(u"refresh")
        self.refresh.setGeometry(QRect(130, 210, 131, 32))
        self.line = QFrame(Form)
        self.line.setObjectName(u"line")
        self.line.setGeometry(QRect(10, 150, 361, 20))
    ...
    def retranslateUi(self, Form):
        ...
        self.button.setText(QCoreApplication.translate("Form", u"Send Parameters", None))
        self.refresh.setText(QCoreApplication.translate("Form", u"Refresh Mass", None))
    # retranslateUi
